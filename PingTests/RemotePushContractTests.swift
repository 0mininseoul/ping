...
final class RemotePushContractTests: XCTestCase {
    func testRegistrarUsesTheMacOSRPCContractAndKeepsTokenInMemory() throws {
        ...
        XCTAssertTrue(source.contains("\"p_token\""))
        XCTAssertTrue(source.contains("\"p_platform\": \"macos\""))
        XCTAssertTrue(source.contains("\"p_environment\""))
        XCTAssertTrue(source.contains("\"p_sound_preference\""))
