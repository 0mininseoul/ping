...
final class ReleaseVersionContractTests: XCTestCase {
    func testCurrentReleaseVersionIsBumpedForSparkleUpdate() throws {
        ...
        XCTAssertTrue(routes.contains("APP_VERSION = \"v0.3.9\""))
        XCTAssertTrue(routes.contains("DOWNLOAD_URL = \"/downloads/Ping-v0.3.9.dmg\""))
        XCTAssertTrue(readme.contains("Ping-v0.3.9.dmg"))
    }
