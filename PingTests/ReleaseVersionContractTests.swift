...
final class ReleaseVersionContractTests: XCTestCase {
    func testCurrentReleaseVersionIsBumpedForSparkleUpdate() throws {
        ...
        XCTAssertTrue(project.contains("MARKETING_VERSION: \"0.1.3\""))
        XCTAssertTrue(project.contains("CURRENT_PROJECT_VERSION: \"5\""))
        XCTAssertTrue(routes.contains("APP_VERSION = \"v0.1.3\""))
        XCTAssertTrue(routes.contains("DOWNLOAD_URL = \"/downloads/Ping-v0.1.3.dmg\""))
        XCTAssertTrue(readme.contains("Ping-v0.1.3.dmg"))
    }
