-- Restore 30-day server-side video retention.
-- The app now relies on client-side download caches to reduce egress while
-- preserving the room history retention contract.
