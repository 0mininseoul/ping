...
export const MAC_APP_VERSION = "v0.3.45";
export const WINDOWS_APP_VERSION = "v0.3.45";
export const MAC_DOWNLOAD_URL = "/downloads/Ping-v0.3.45.dmg";
export const WINDOWS_DOWNLOAD_URL = "/downloads/windows/PingSetup-v0.3.45.exe";
