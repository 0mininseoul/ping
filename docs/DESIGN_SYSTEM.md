...
Ping은 macOS 메뉴바에 상주하는 3초 영상 메시지 앱이다. UI는 화려한 데모형 글래스가 아니라, 작업 중인 사용자가 빠르게 이해하고 지나갈 수 있는 조용한 네이티브 도구처럼 보여야 한다.
...
> Option+P로 거울을 열고, Enter로 3초를 보냅니다.

Copy rules:
- “3초 영상 메시지”보다 “보고 싶을 때 바로”를 우선한다.
